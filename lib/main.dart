...
import 'package:sunshine/screens/onboarding_scrrens/onboarding_screen.dart';
import 'package:sunshine/screens/splash_screen.dart';
import 'package:sunshine/services/notification_controller.dart';
    ...
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        ...
        home: FirebaseAuth.instance.currentUser != null
            ? SplashScreen()
            : OnboardingScreens(),
        // FirebaseAuth.instance.currentUser != null ? HomeScreen() : Goals(),
        routes: {
          Goals.screenName: (context) => Goals(
                onPressed: () {},
              ),
          NameScreen.screenName: (context) => NameScreen(
                onPressed: () {},
              ),
          DateScreen.screenName: (context) => DateScreen(
                onPressed: () {},
              ),
          LoginScreen.screeName: (context) => LoginScreen(
                onPressed: () {},
              ),
